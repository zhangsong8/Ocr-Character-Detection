...
/*CNN GetTopN parameter*/
typedef struct hiSAMPLE_SVP_NNIE_KEYPOINT_SOFTWARE_PARAM_S
{
	HI_U32 u32OutnChannel;
	HI_U32 u32OutHeight;
	HI_U32 u32OutWidth;
	SVP_MEM_INFO_S stGetResultTmpBuf;
}SAMPLE_SVP_NNIE_KEYPOINT_SOFTWARE_PARAM_S;
...
typedef struct hiSAMPLE_SVP_NNIE_YOLOV2_SOFTWARE_PARAM_S
{
 ...
 typedef struct hiSAMPLE_SVP_NNIE_LANENET_SOFTWARE_PARAM_S
{
     HI_U32 u32OriImHeight;
     HI_U32 u32OriImWidth;
	 HI_U32 u32OutHeight;
	 HI_U32 u32OutWidth;
	 HI_U32 u32BinChannel;
	 HI_U32 u32SegChannel;

	 SVP_MEM_INFO_S stGetResultTmpBuf;
}SAMPLE_SVP_NNIE_LANENET_SOFTWARE_PARAM_S;
/*stat performance*/
