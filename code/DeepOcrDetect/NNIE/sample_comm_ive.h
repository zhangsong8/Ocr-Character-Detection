...
typedef struct hiIVE_IMAGE_FILL_U8C3_PLANAR_S
{
	HI_U8   u8Type;
	HI_U32  u32SrcPhyAddr[3];
	HI_U32  u32DstPhyAddr[3];
	HI_U16  u16SrcStride[3];
	HI_U16  u16DstStride[3];
	HI_U16  u16SrcWidth;
	HI_U16  u16SrcHeight;
	HI_U16  u16DstWidth;
	HI_U16  u16DstHeight;
...
HI_S32 SAMPLE_COMM_IVE_DmaImage_YVU420SP(VIDEO_FRAME_INFO_S *pstFrameInfo,IVE_DST_IMAGE_S *pstDst,HI_BOOL bInstant);
